...
export default function SellerModal({ seller, stateName, onClose, variant = 'orange' }) {
  ...
  const waMessage = `Olá ${seller.name}! Vi a promoção na página Pack Showroom ATOMI e tenho interesse nos produtos. Sou do estado de ${stateName}. Pode me passar mais informações?`;
